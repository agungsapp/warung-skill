						...
						<div class="widget_shopping_cart_content">
								<ul class="woocommerce-mini-cart cart_list product_list_widget">
										<li class="woocommerce-mini-cart-item mini_cart_item">
												...
												<a href="#"><img src="{{ asset('user') }}/img/product/product_thumb_1_1.jpg" alt="Cart Image">Plastic
														Book Bags</a>
										...
										<li class="woocommerce-mini-cart-item mini_cart_item">
												<a href="#" class="remove remove_from_cart_button"><i class="far fa-times"></i></a>
												<a href="#"><img src="{{ asset('user') }}/img/product/product_thumb_1_2.jpg" alt="Cart Image">The
														Genie Mind</a>
												<span class="quantity">1 ×
														<span class="woocommerce-Price-amount amount">
										...
										<li class="woocommerce-mini-cart-item mini_cart_item">
												<a href="#" class="remove remove_from_cart_button"><i class="far fa-times"></i></a>
												<a href="#"><img src="{{ asset('user') }}/img/product/product_thumb_1_3.jpg" alt="Cart Image">The
														Energy Book</a>
												<span class="quantity">1 ×
														<span class="woocommerce-Price-amount amount">
										...
										<li class="woocommerce-mini-cart-item mini_cart_item">
												<a href="#" class="remove remove_from_cart_button"><i class="far fa-times"></i></a>
												<a href="#"><img src="{{ asset('user') }}/img/product/product_thumb_1_4.jpg" alt="Cart Image">Pencil
														Bag</a>
												<span class="quantity">1 ×
														<span class="woocommerce-Price-amount amount">
										...
										<li class="woocommerce-mini-cart-item mini_cart_item">
												<a href="#" class="remove remove_from_cart_button"><i class="far fa-times"></i></a>
												<a href="#"><img src="{{ asset('user') }}/img/product/product_thumb_1_5.jpg"
...
<div class="th-menu-wrapper">
		<div class="th-menu-area text-center">
				...
				<div class="mobile-logo">
						<a href="./"><img src="{{ asset('user') }}/img/logo.webp" alt="Edura"></a>
				</div>
														...
														<div class="col-auto">
																<nav class="main-menu d-none d-lg-inline-block">
																		<ul>
																				<li class="menu-item-has-children">
																						<a href="index.html">
																								<div style="height:12px;font-size: 10px;">Warung<br>
																								</div>E-Course
																						</a>
																						<ul class="sub-menu">
																								<li><a href="?mod=page/course&pg=course">E-Course Karir</a></li>
																								<li><a href="?mod=page/course&pg=course">E-Course Digital Marketing</a></li>
																								<li><a href="?mod=page/course&pg=course">E-Course Programming</a></li>
																								<li><a href="?mod=page/course&pg=course">E-Course Creative</a></li>
																						</ul>
																				</li>
																				<li class="menu-item-has-children">
																						<a href="#">
																						...
																						<ul class="sub-menu">
																								<li><a href="?mod=page/course&pg=course">Karir</a></li>
																								<li><a href="?mod=page/course&pg=course">Digital Marketing</a></li>
																						</ul>
																				</li>
																				...
																				<li class="menu-item-has-children">
																						...
																						<ul class="sub-menu">
																								<li><a href="about.html">WA Boomber</a></li>
																								<li><a href="event.html">Woowa CRM</a></li>
																						</ul>
																				</li>
																				<li class="menu-item-has-children">
																						<a href="#">Give Away</a>
																						<ul class="sub-menu">
																								<li><a href="blog.html">Informasi Give Away</a></li>
																						</ul>
																				</li>
																				<li class="menu-item-has-children">
																						<a href="#">Informasi</a>
																						<ul class="sub-menu">
																								<li><a href="blog.html">Informasi Beasiswa</a></li>
																						</ul>
																				</li>
																		</ul>
																</nav>
